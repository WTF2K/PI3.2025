                ...
                <div className="inicio-admin">
                  ...
                  <div className="row mb-4">
                    <div className="col-md-2 col-sm-6 mb-3">
                      <div className="card text-center h-100" style={{ background: "#f8f9fa", border: "1px solid #314B66" }}>
                        <div className="card-body">
                          <FontAwesomeIcon icon={faBriefcase} size="2x" className="text-primary mb-2" />
                    ...
                    <div className="col-md-2 col-sm-6 mb-3">
                      <div className="card text-center h-100" style={{ background: "#f8f9fa", border: "1px solid #314B66" }}>
                        <div className="card-body">
                          <FontAwesomeIcon icon={faTimesCircle} size="2x" className="text-warning mb-2" />
                    ...
                    <div className="col-md-2 col-sm-6 mb-3">
                      <div className="card text-center h-100" style={{ background: "#f8f9fa", border: "1px solid #314B66" }}>
                        <div className="card-body">
                          <FontAwesomeIcon icon={faUserGraduate} size="2x" className="text-info mb-2" />
                    ...
                    <div className="col-md-2 col-sm-6 mb-3">
                      <div className="card text-center h-100" style={{ background: "#f8f9fa", border: "1px solid #314B66" }}>
                        <div className="card-body">
                          ...
                          <h5 className="card-title">{stats.total > 0 ? Math.round((stats.atribuidas / stats.total) * 100) : 0}%</h5>
                  ...
                  <div className="row mb-4">
                    <div className="col-12">
                      <div className="card" style={{ background: "#f8f9fa", border: "1px solid #314B66" }}>
