    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const ativas = propostas.filter(
          (p) => p.ativa && !p.atribuida_estudante
        ).length;
        const inativas = propostas.filter(
          (p) => !p.ativa && !p.atribuida_estudante
        ).length;
        const atribuidas = propostas.filter(
          (p) => p.atribuida_estudante
        ).length;
                      ...
                      >
                        <div className="card-body">
                          ...
                          <h5 className="card-title">
                            {stats.total > 0
                              ? Math.round(
                                  (stats.atribuidas / stats.total) * 100
                                ): 0}
                            %
                          </h5>
                      ...
                      >
                        ...
                        <div className="card-body">
                          <div className="d-flex flex-wrap gap-2">
                            ...
                            <Link
                              to="/empresa/propostas?filter=ativas"
                            ...
                            <Link
                              to="/empresa/propostas?filter=atribuidas"
